...
<x-backpack::menu-item title="Types" icon="la la-list" :link="backpack_url('type')" />
<x-backpack::menu-item title="Subjects" icon="la la-book" :link="backpack_url('subject')" />
<x-backpack::menu-item title="Professors" icon="la la-user-tie" :link="backpack_url('profesor')" />
